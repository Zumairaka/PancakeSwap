 ...
 */
contract RastaProfile is AccessControl, ERC721Holder {
...
contract IFOInitializable is IIFOV2, ReentrancyGuard, Ownable {
    ...
    // RastaProfile
    RastaProfile public rastaProfile;
     ...
     * @param _rastaProfileAddress: the address of the RastaProfile
    ...
    function initialize(
        ...
        rastaProfile = RastaProfile(_rastaProfileAddress);
        ...
        notContract
    {
        ...
        require(
            rastaProfile.getUserStatus(msg.sender),
    ...
    function _claimPoints(address _user) internal {
        if (!_hasClaimedPoints[_user]) {
            ...
            if (sumPools > thresholdPoints) {
                ...
                rastaProfile.increaseUserPoints(
                    msg.sender,
                    numberPoints,
                    campaignId
                );
